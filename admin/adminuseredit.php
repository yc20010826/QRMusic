...
if($_GET['id'] == ''){
	@$id = '95859';
	@$user = mysql_fetch_assoc(mysql_query("select * from yc_admin where id=$id"));
	@$userid = $user['id'];
...
<form id="adminusereditform">
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        <input value="<?php echo $Jurisdiction?>" type="text" name="Jurisdiction" lay-verify="required" placeholder="请输入角色类型" autocomplete="off" class="layui-input">
      </div>
    </div>
    <div class="layui-form-item">
...
<script>
	$("#aduserpost").click(function(){
		$.ajax({
			url:"class/adminusereditpost.php",
			type:"post",
			async:true,
