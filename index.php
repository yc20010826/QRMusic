        ...
        <div class="btn-bar">
            ...
            <div class="btn-box" id="btn-area">
                ...
                <span class="btn" data-action="search" title="点击搜索音乐">歌曲搜索</span>
						<a href="http://wpa.qq.com/msgrd?v=3&uin=<?php echo $Contact_QQ?>&site=qq&menu=yes"><span class="btn" data-action="Contact_QQ" title="联系客服">联系客服</span></a>
						<span class="btn1" id="loginbtn" title="登录/注册">登录/注册</span>
            </div>
        </div>  <!--class="btn-bar"-->
...
<div class="footer">
    ...
    <div class="copyright"><!--版权底部-->
	    <p><?php echo $icp?></p>
	    <p><?php echo $copyright?></p>
    </div>
	 <div class="fduser" id="fduser">
...
<script>
//function.js下载位置使用Ajaxpost一个虚参到设计的用户信息查询页面，那个页面echo返回一个下载剩余的值，然后再在function.js里面下载位置判断是否还有权限下载
</script>
<!-- 站长统计代码 -->
